...
(* OASIS_START *)
(* DO NOT EDIT (digest: ec4ff36aaa0f7ce52a3e02127ada1b72) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_vcr.ml"});
               Executable
                 ({
                     cs_name = "test_bdd";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_bdd.ml"});
               Test
                 ({
                     cs_name = "test_bdd";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "x\185\167* ^\219\189\216\188\0290M\242\231\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
